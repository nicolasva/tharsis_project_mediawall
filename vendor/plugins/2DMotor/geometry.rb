...
module SVuGy
  module AddGeometry
    # factory method for Point class; attention: this shadows 'p' used for debugging
    def pt (x, y)
      Point.new(self, x, y)
    end
  ...
  # A point with x and y coordinates (not as such part of SVG)
  class Point
    ...
    def local (reference) # temporary fix
