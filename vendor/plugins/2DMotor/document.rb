module SVuGy
  class Document
    ...
    def register_id (id, object)
      if @ids[id]
        #@@@ this should probably produce an error
    ...
    #@@@@ This method is a duplicate of the one in Shape
    #@@@@ think about common inheritance
...
# include marker definition for arrows if needed
# adapted from SVG Essentials, p. 98
if $there_are_arrows
  result << <<-DEFS
  <defs>
